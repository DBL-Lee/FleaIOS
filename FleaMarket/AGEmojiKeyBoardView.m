...
- (instancetype)initWithFrame:(CGRect)frame dataSource:(id<AGEmojiKeyboardViewDataSource>)dataSource {
  ...
  if (self) {
    ...
    self.emojiPagesScrollView.showsVerticalScrollIndicator = NO;
      self.emojiPagesScrollView.scrollEnabled = YES;
      self.emojiPagesScrollView.directionalLockEnabled = YES;
      self.emojiPagesScrollView.panGestureRecognizer.delaysTouchesBegan = YES;
