...
if [[ "$CONFIGURATION" == "Debug" ]]; then
  install_framework "Pods-FleaMarket/AWSCognito.framework"
  install_framework "Pods-FleaMarket/AWSCore.framework"
  install_framework "Pods-FleaMarket/AWSS3.framework"
  install_framework "Pods-FleaMarket/Alamofire.framework"
  install_framework "Pods-FleaMarket/DZNEmptyDataSet.framework"
